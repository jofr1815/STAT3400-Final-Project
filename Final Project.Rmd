...
m <- polr(voter_category ~ educ + income_cat + race + gender + ppage + weight, data = vote, Hess = TRUE)
summary(m)

table(vote$voter_category, vote$educ)

predictvote = predict(m, vote)
table(vote$voter_category, predictvote)
```
