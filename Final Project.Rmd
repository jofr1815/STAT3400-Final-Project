...
# This will eventually be moved to the top into a new column to simplify later steps
...
Now we can split the basic data into the training and testing sets

```{r}
# Use the generated vector to split the data 
```
