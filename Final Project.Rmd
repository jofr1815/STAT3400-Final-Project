...
voteBasic$voteChance <- as.numeric(recode_factor(voteBasic$voter_category, "rarely/never" = 1, "sporadic" = 2, "always" = 3))

head(voteBasic$voteChance)
summary(voteBasic$voteChance)
head(voteBasic)
```
...
Next, we can create a set of box plots to visualize the means and variance of each level. 
