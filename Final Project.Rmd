...
```{r}
basicOLR <- polr(voter_category ~ educ + income_cat + race + gender + ppage + weight, data = basicTraining, Hess = TRUE)
summary(basicOLR)
```
...
```{r}
predictvote = predict(basicOLR, basicTesting)
conf <- table(basicTesting$voter_category, predictvote)
conf
mean(as.character(basicTesting$voter_category) != as.character(predictvote))

confusionMatrix(basicTesting$voter_category, predictVote)
```
...
```{r}
TukeyHSD(aov(vote$voteChance ~ vote$Q8_1))
```
...
barrier1 <- ggplot(vote, aes(x = factor(Q18_1, levels = c("Yes", "No", "Not at all", "No Response")), fill = factor(voter_category, levels = c("rarely/never", "sporadic", "always")))) + # Create basic Plot
  geom_bar(position = "fill") + 
  xlab("Personal Experience") + ylab("% of Respondents") + ggtitle("No Correct Id") +# Add axis labels
  guides(fill = guide_legend(title = "Voter Category")) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) # Rotate category labels 
...
barrier2 <- ggplot(vote, aes(x = factor(Q18_2, levels = c("Yes", "No", "Not at all", "No Response")), fill = factor(voter_category, levels = c("rarely/never", "sporadic", "always")))) + # Create basic Plot
  geom_bar(position = "fill") + 
  xlab("Personal Experience") + ylab("% of Respondents") + ggtitle("Couldnt Find Polling Place") +# Add axis labels
  guides(fill = guide_legend(title = "Voter Category")) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) # Rotate category labels
...
barrier4 <- ggplot(vote, aes(x = factor(Q18_4, levels = c("Yes", "No", "Not at all", "No Response")), fill = factor(voter_category, levels = c("rarely/never", "sporadic", "always")))) + # Create basic Plot
  geom_bar(position = "fill") + 
  xlab("Personal Experience") + ylab("% of Respondents") + ggtitle("Unable to Acess Poling Place") +# Add axis labels
  guides(fill = guide_legend(title = "Voter Category")) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) # Rotate category labels
...
TukeyHSD(aov(vote$voteChance ~ vote$Q18_2))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_3))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_4))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_5))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_6))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_7))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_8))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_9))
TukeyHSD(aov(vote$voteChance ~ vote$Q18_10))
```
...
m <- polr(voter_category ~ educ + income_cat + race + gender + ppage + weight + Q18_1 + Q5 + Q6 + Q7 + Q9_1 + Q9_2 + Q9_3 + Q9_4 + Q10_1 + Q11_1 + Q11_2 + Q11_3 + Q11_4 + Q11_5 + Q11_6 + Q16 + Q20 + Q21 + Q24 + Q25 + Q26 + Q30 + Q18_2 + Q18_3 + Q18_4 + Q18_5 + Q18_6 + Q18_7 + Q18_8 + Q18_9 + Q18_10 + Q8_2 + Q8_3 + Q8_4 + Q8_5 + Q8_7 + Q8_8 + Q8_9 + Q15 + Q14 + Q2_1 + Q2_2 + Q2_3 + Q2_4 + Q2_5 + Q2_6 + Q2_7 + Q2_8 + Q2_9 + Q2_10 + Q3_2 + Q3_3 + Q3_4 + Q3_5 + Q3_6 + Q4_1  + Q4_3 + Q4_4 + Q4_5, data = voteTraining, Hess = TRUE)
summary(m)

#Removed: 

predictvote = predict(m, voteTesting)
table(basicTesting$voter_category, predictvote)
mean(as.character(voteTesting$voter_category) != as.character(predictvote))
```
...
```
```{r}
corrplot(cov2cor(vcov(m)), method = "color")
```
```{r}
